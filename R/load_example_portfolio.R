...
load_example_portfolio <- function() {
  ...
  dplyr::tribble(
    ...
    "Johnson & Johnson", "JNJ",       "2021-12-14", 168,    50,      "USA",     "USD",     "No", "Value",  "Health care",            "Large", "Nordnet",     NA,    NA,
    "Novo Nordisk A/S",  "NOVO-B.CO", "2022-01-03", 747,    100,     "Denmark", "DKK",     "No", "Growth", "Health care",            "Large", "Danske Bank", NA,    NA,
