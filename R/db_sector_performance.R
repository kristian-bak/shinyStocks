...
#' 
db_sector_performance <- function(updateProgress = NULL, folder_name = "performance", max_days = 3) {
  
  file_name <- get_file_name(stock_name = "sector", folder_name = "performance")
  ...
  obj <- get_sector_performance(updateProgress = updateProgress)
